...
drop table if exists sec_role_permission_relation;
...
drop index if exists idx_role_datecreated;
...
drop index if exists idx_user_datecreated;
...
drop sequence if exists role_perm_relation_sequence;
...
drop sequence if exists role_user_relation_sequence;
