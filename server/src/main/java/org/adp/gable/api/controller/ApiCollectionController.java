...
import org.adp.gable.api.service.DocAutoGenerateService;
...
public class ApiCollectionController {
    ...
    @Resource
    private DocAutoGenerateService docAutoGenerateService;
    ...
    public Result<Long> updateApi(@RequestParam Long id,@RequestBody HttpApiDto http) {
        ...
        this.docAutoGenerateService.autoGenerateDefaultDoc(id, http);
        return Result.success(id);
    }
