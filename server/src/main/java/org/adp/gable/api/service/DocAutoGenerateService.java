...
public class DocAutoGenerateService {
    ...
    public void autoGenerateDefaultDoc(Long id, HttpApiDto waitForSave) {
        ...
        // delete all blocks
        this.docBlockDao.deleteByDocDefineIdAndOrderLessThan(docDefineId, 0);
    ...
    private List<DocBlockDto> doGenerateDocs(Long docDefineId, HttpApiDto waitForSave, Long httpId) {
        ...
        int order = 1;
        // generate url title
        blocks.add(DocBlockUtils.generateI18nTitle("PAGES.DOCS.DOC_HEADER_URL", order++, docDefineId));
        // generate url
